...
public class additiveMyCpr1 implements Comparable<additiveMyCpr1> {
  ...
  public int compareTo(additiveMyCpr1 other) {
    ...
    return mdict.replaceReg.matcher(key).replaceAll(mdict.emptyStr).toLowerCase()
        .compareTo(mdict.replaceReg.matcher(other.key).replaceAll(mdict.emptyStr).toLowerCase());
  }
